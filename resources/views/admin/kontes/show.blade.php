    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="d-flex gap-5">
                <img src="{{ asset('images/kontes/' . $kontes->poster_kontes) ?? 'https://st2.depositphotos.com/1561359/12101/v/950/depositphotos_121012076-stock-illustration-blank-photo-icon.jpg' }}"
